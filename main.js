...
function checkAnswer2() {
  if (document.getElementById("secondA").value !== answer2) {
    $('.char2').css("background-color", "red")
  }else {
    $('.char2').css("background-color", "green")
  $( "input[id='checkb2']" ).prop({
    disabled: true });
  }
}
function checkAnswer3() {
  if (document.getElementById("thirdA").value !== answer3) {
    $('.char3').css("background-color", "red")
  }
  else {
  $( "input[id='checkb3']" ).prop({
    disabled: true });
    $('.char3').css("background-color", "green")
}
}
...
function checkAnswer5() {
  if (document.getElementById("fifthA").value !== answer5) {
    $('.char5').css("background-color", "red")
  }
  else {
  $( "input[id='checkb5']" ).prop({
    disabled: true });
...
<div id="leftBox2">
  <table id="puzzel">
    <tr id ='tr1'>
      ...
      <td id="cross" bgcolor="#FFFFFF"></td>
      <td id="cross" bgcolor="#FFFFFF"></td>
      <td id="cross" class='char2'>5/2</td>
      <td id="cross" class='char2'>?</td>
      <td id="cross" class='char2'>?</td>
      <td id="cross" class='char2'>?</td>
      <td id="cross" class='char2'>?</td>
      <td id="cross" class='char2'>?</td>
    ...
    <tr id='tr4'>
      ...
      <td id="cross" bgcolor="#FFFFFF"></td>
      <td id="cross" bgcolor="#FFFFFF">?</td>
      <td id="cross" class = "char1">1</td>
      <td id="cross" class = "char1">?</td>
      <td id="cross"  class ='char1'>?</td>
      <td id="cross" class = "char1">?</td>
      <td id="cross" class = "char1">?</td>
      <td id="cross" class = "char1">?</td>
    ...
    <tr id='tr7'>
      <td id="cross" class = 'char3'>3</td>
      <td id="cross" class = 'char3'>?</td>
      <td id="cross" class = 'char3'>?</td>
      <td id="cross" class = 'char3'>?</td>
      <td id="cross" class = 'char2'>?</td>
      <td id="cross" class = 'char3'>?</td>
